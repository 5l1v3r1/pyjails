...
You'll start with a Kronenbourg (you really want to drink that thing?), prove me that you can dig into the data and you'll get a better beer.
...
def verify_flag(flag):
    ...
    if true_flag==flag:
        print("Well done, you managed to get the flag !\nLet's have a better beer !\n\nNext time you'll come, you'll have access to this new beer with this flag as password into the user pybeer2")
    else:
...
class beer:
    ...
    def __init__(self,empty=False,name="Une superbe 8.6", flag="H2G2{Ev3ry_PyJ41l_StARt_wi7h_a_dir()}"):
        self._empty=empty
...
kronenbourg=beer(name="Kronenbourg")
...
def main():
    ...
    def sandbox():
        ...
        exec_code({"kronenbourg":kronenbourg,"verify_flag":verify_flag})
