...
Wow, you stepped up ! Now you can drink a Tank 7.
Is the same thing than the third jail... But a bit more annoying.
...
def verify_flag(flag):
    ...
    if true_flag==flag:
        print("Well done, you managed to get the flag !\nLet's have a better beer !\n\nNext time you'll come, you'll have access to this new beer with this flag as passord to the user pybeer5")
    else:
...
tank7=beer(name="Tank 7", flag="You said a flag ?")
...
def main():
    ...
    def sandbox():
        ...
        exec_code({"tank7":tank7,"verify_flag":verify_flag})
